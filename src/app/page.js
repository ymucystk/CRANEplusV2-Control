...
const Assets = ()=>{
  return (
    <a-assets>
      {/*IGUS_REBEL*/}
      <a-asset-items id="base" src="CRANEplusV2_base.gltf" ></a-asset-items>
      <a-asset-items id="j1" src="CRANEplusV2_j1.gltf" ></a-asset-items>
      <a-asset-items id="j2" src="CRANEplusV2_j2.gltf" ></a-asset-items>
      <a-asset-items id="j3" src="CRANEplusV2_j3.gltf" ></a-asset-items>
      <a-asset-items id="j4" src="CRANEplusV2_j4.gltf" ></a-asset-items>
      <a-asset-items id="j5" src="CRANEplusV2_j5.gltf" ></a-asset-items>
    </a-assets>
  )
}
  ...
  return (<>{visible?
    <a-entity gltf-model="#base" position="0 0 0" rotation={`0 0 0`}>
      <a-entity gltf-model="#j1" position="0 0 0" rotation={`0 ${j1_rotate} 0`}>
        <a-entity gltf-model="#j2" position="0 0.07134 0" rotation={`0 0 ${j2_rotate}`}>
          <a-entity gltf-model="#j3" position="0 0.08303 0" rotation={`0 0 ${j3_rotate}`}>
            <a-entity gltf-model="#j4" position="0 0.09351 0" rotation={`0 0 ${j4_rotate}`}>
              <a-entity gltf-model="#j5" position="0 0.045 0.0145" rotation={`${j5_rotate} 0 0`}>
              </a-entity>
            </a-entity>
          </a-entity>
        </a-entity>
